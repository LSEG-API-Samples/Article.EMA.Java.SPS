...
// *|           Copyright Refinitiv 2016. All rights reserved.            		--
///*|----------------------------------------------------------------------------------------------------

package com.refinitiv.ema.examples;
...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			consumer  = EmaFactory.createOmmConsumer(EmaFactory.createOmmConsumerConfig().host("localhost:1116").username("user"));
